...
export const Footer = () => {
  return (
    <div>
       ...
       <div className="md:w-full w-auto bg-[#F9F1E7] flex justify-center items-center  pt-14 ">
      ...
      <div className="bg-[#F9F1E7] shadow-lg pt-6 md:w-full w-auto">
      <p className="pl-10 text-gray-400">2023 furino. All rights reverved</p>
      </div>
